...
# KvpObjectDoubleSourceAttribute

Namespace: Jlw.Utilities.Testing.DataSources

```csharp
public class KvpObjectDoubleSourceAttribute : DataSourceAttributeBase, Microsoft.VisualStudio.TestTools.UnitTesting.ITestDataSource
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Attribute](https://docs.microsoft.com/en-us/dotnet/api/system.attribute) → [DataSourceAttributeBase](./jlw.utilities.testing.datasources.datasourceattributebase) → [KvpObjectDoubleSourceAttribute](./jlw.utilities.testing.datasources.kvpobjectdoublesourceattribute)<br>
...
```csharp
public KvpObjectDoubleSourceAttribute()
```
