...
# KvpObjectBoolSourceAttribute

Namespace: Jlw.Utilities.Testing.DataSources

```csharp
public class KvpObjectBoolSourceAttribute : DataSourceAttributeBase, Microsoft.VisualStudio.TestTools.UnitTesting.ITestDataSource
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Attribute](https://docs.microsoft.com/en-us/dotnet/api/system.attribute) → [DataSourceAttributeBase](./jlw.utilities.testing.datasources.datasourceattributebase) → [KvpObjectBoolSourceAttribute](./jlw.utilities.testing.datasources.kvpobjectboolsourceattribute)<br>
...
```csharp
public KvpObjectBoolSourceAttribute()
```
